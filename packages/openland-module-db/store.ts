...
export class Message extends Entity<MessageShape> {
    ...
    get attachmentsModern(): ({ type: 'file_attachment', id: string, fileId: string, filePreview: string | null, fileMetadata: { name: string, size: number, isImage: boolean, isStored: boolean, imageWidth: number | null, imageHeight: number | null, imageFormat: string | null, mimeType: string } | null } | { type: 'rich_attachment', id: string, title: string | null, subTitle: string | null, titleLink: string | null, text: string | null, icon: { uuid: string, crop: { x: number, y: number, w: number, h: number } | null } | null, image: { uuid: string, crop: { x: number, y: number, w: number, h: number } | null } | null, iconInfo: { name: string, size: number, isImage: boolean, isStored: boolean, imageWidth: number | null, imageHeight: number | null, imageFormat: string | null, mimeType: string } | null, imageInfo: { name: string, size: number, isImage: boolean, isStored: boolean, imageWidth: number | null, imageHeight: number | null, imageFormat: string | null, mimeType: string } | null, imagePreview: string | null, imageFallback: { photo: string, text: string } | null, titleLinkHostname: string | null, keyboard: { buttons: (({ title: string, style: 'DEFAULT' | 'LIGHT' | 'PAY', url: string | null })[])[] } | null, socialImage: { uuid: string, crop: { x: number, y: number, w: number, h: number } | null } | null, socialImagePreview: string | null, socialImageInfo: { name: string, size: number, isImage: boolean, isStored: boolean, imageWidth: number | null, imageHeight: number | null, imageFormat: string | null, mimeType: string } | null })[] | null { return this._rawValue.attachmentsModern; }
    ...
    get purchaseId(): string | null { return this._rawValue.purchaseId; }
    set purchaseId(value: string | null) {
        let normalized = this.descriptor.codec.fields.purchaseId.normalize(value);
        if (this._rawValue.purchaseId !== normalized) {
            this._rawValue.purchaseId = normalized;
            this._updatedValues.purchaseId = normalized;
            this.invalidate();
        }
    }
...
export class MessageFactory extends EntityFactory<MessageShape, Message> {
    ...
    static async open(storage: EntityStorage) {
        ...
        fields.push({ name: 'purchaseId', type: { type: 'optional', inner: { type: 'string' } }, secure: false });
        ...
        let codec = c.struct({
            ...
            purchaseId: c.optional(c.string),
...
export interface WalletPurchaseShape {
    ...
    deleted: boolean | null;
    amount: number;
    product: { type: 'group', gid: number } | { type: 'donate_message', uid: number, cid: number } | { type: 'donate_reaction', uid: number, mid: number };
...
export class WalletPurchase extends Entity<WalletPurchaseShape> {
    ...
    get product(): { type: 'group', gid: number } | { type: 'donate_message', uid: number, cid: number } | { type: 'donate_reaction', uid: number, mid: number } { return this._rawValue.product; }
    set product(value: { type: 'group', gid: number } | { type: 'donate_message', uid: number, cid: number } | { type: 'donate_reaction', uid: number, mid: number }) {
...
export class WalletPurchaseFactory extends EntityFactory<WalletPurchaseShape, WalletPurchase> {
    ...
    static async open(storage: EntityStorage) {
        ...
        fields.push({ name: 'product', type: { type: 'union', types: { group: { gid: { type: 'integer' } }, donate_message: { uid: { type: 'integer' }, cid: { type: 'integer' } }, donate_reaction: { uid: { type: 'integer' }, mid: { type: 'integer' } } } }, secure: false });
        ...
        let codec = c.struct({
            ...
            deleted: c.optional(c.boolean),
            amount: c.integer,
            product: c.union({ group: c.struct({ gid: c.integer }), donate_message: c.struct({ uid: c.integer, cid: c.integer }), donate_reaction: c.struct({ uid: c.integer, mid: c.integer }) }),
