...
export interface ConferenceRoomCreateShape {
    strategy?: 'mash' | 'sfu' | null | undefined;
...
export class ConferenceRoom extends Entity<ConferenceRoomShape> {
    get id(): number { return this._rawValue.id; }
    get strategy(): 'mash' | 'sfu' | null { return this._rawValue.strategy; }
    set strategy(value: 'mash' | 'sfu' | null) {
...
export class ConferenceRoomFactory extends EntityFactory<ConferenceRoomShape, ConferenceRoom> {
    ...
    static async open(storage: EntityStorage) {
        ...
        primaryKeys.push({ name: 'id', type: 'integer' });
        let fields: FieldDescriptor[] = [];
        fields.push({ name: 'strategy', type: { type: 'optional', inner: { type: 'enum', values: ['mash', 'sfu'] } }, secure: false });
        ...
        let codec = c.struct({
            id: c.integer,
            strategy: c.optional(c.enum('mash', 'sfu')),
