...
// migrations.push({
//     key: '49-fix-user-messaging-state',
//     migration: async (root, log) => {
//         let allKeys = await FDB.UserMessagingState.findAllKeys(root);
//         let keyBatches = batch(allKeys, 100);
//         for (let kb of keyBatches) {
...
// migrations.push({
//     key: '50-fix-user-messaging-state',
//     migration: async (root, log) => {
//         let allKeys = await FDB.UserMessagingState.findAllKeys(root);
//         let keyBatches = batch(allKeys, 100);
//         for (let kb of keyBatches) {
...
// migrations.push({
//     key: '51-fix-user-messaging-state',
//     migration: async (root, log) => {
//         let allKeys = await FDB.UserMessagingState.findAllKeys(root);
//         let keyBatches = batch(allKeys, 100);
//         for (let kb of keyBatches) {
...
// migrations.push({
//     key: '52-fix-user-messaging-state',
//     migration: async (root, log) => {
//         let allKeys = await FDB.UserMessagingState.findAllKeys(root);
//         let keyBatches = batch(allKeys, 100);
//         for (let kb of keyBatches) {
...
// migrations.push({
//     key: '53-fix-user-messaging-state',
//     migration: async (root, log) => {
//         let allKeys = await FDB.UserMessagingState.findAllKeys(root);
//         let keyBatches = batch(allKeys, 100);
//         for (let kb of keyBatches) {
...
// migrations.push({
//     key: '54-fix-user-messaging-state',
//     migration: async (root, log) => {
//         let allKeys = await FDB.UserMessagingState.findAllKeys(root);
//         let keyBatches = batch(allKeys, 100);
//         for (let kb of keyBatches) {
