...
import { FID, unpackFID, packFID, packKeyFID } from 'foundation-orm/FID';
...
export class Online extends FEntity {
    get uid(): FID { return unpackFID(this._value.uid); }
    get lastSeen(): number {
...
export class OnlineFactory extends FEntityFactory<Online> {
    ...
    async findById(uid: FID) {
        return await this._findById([packKeyFID(uid)]);
    }
    async create(uid: FID, shape: OnlineShape) {
        return await this._create([packKeyFID(uid)], { uid, ...shape });
    }
    watch(uid: FID, cb: () => void) {
        return this._watch([packKeyFID(uid)], cb);
    }
...
export class PresenceFactory extends FEntityFactory<Presence> {
    ...
    async findById(uid: FID, tid: string) {
        return await this._findById([packKeyFID(uid), tid]);
    }
    async create(uid: FID, tid: string, shape: PresenceShape) {
        return await this._create([packKeyFID(uid), tid], { uid, tid, ...shape });
    }
    watch(uid: FID, tid: string, cb: () => void) {
        return this._watch([packKeyFID(uid), tid], cb);
    }
    protected _createEntity(value: any, isNew: boolean) {
...
export class AuthToken extends FEntity {
    ...
    get uid(): FID {
        return unpackFID(this._value.uid);
    }
    set uid(value: FID) {
        this._checkIsWritable();
        if (value) {
            let converted = packFID(value);
            if (converted === this._value.uid) { return; }
            this._value.uid = value;
            this.markDirty();
        } else {
            if (!this._value.uid) { return; }
            this._value.uid = null;
            this.markDirty();
        }
    }
    get lastIp(): string {
...
export class PushFirebaseFactory extends FEntityFactory<PushFirebase> {
    ...
    async allFromUserAfter(uid: FID, after: string) {
        return await this._findRangeAllAfter(['__indexes', 'user', packKeyFID(uid)], after);
    }
    async rangeFromUser(uid: FID, limit: number, reversed?: boolean) {
        return await this._findRange(['__indexes', 'user', packKeyFID(uid)], limit, reversed);
    }
    async rangeFromUserWithCursor(uid: FID, limit: number, after?: string, reversed?: boolean) {
        return await this._findRangeWithCursor(['__indexes', 'user', packKeyFID(uid)], limit, after, reversed);
    }
    async allFromUser(uid: FID) {
        return await this._findAll(['__indexes', 'user', packKeyFID(uid)]);
    }
    createUserStream(uid: FID, limit: number, after?: string) {
        return this._createStream(['entity', 'pushFirebase', '__indexes', 'user', packKeyFID(uid)], limit, after); 
    }
...
export class UserProfilePrefil extends FEntity {
    get id(): FID { return unpackFID(this._value.id); }
...
export class UserProfilePrefilFactory extends FEntityFactory<UserProfilePrefil> {
    ...
    async findById(id: FID) {
        return await this._findById([packKeyFID(id)]);
    }
    async create(id: FID, shape: UserProfilePrefilShape) {
        return await this._create([packKeyFID(id)], { id, ...shape });
    }
    watch(id: FID, cb: () => void) {
        return this._watch([packKeyFID(id)], cb);
    }
    protected _createEntity(value: any, isNew: boolean) {
...
export class UserProfileFactory extends FEntityFactory<UserProfile> {
    ...
    async create(id: FID, shape: UserProfileShape) {
        return await this._create([packKeyFID(id)], { id, ...shape });
    }
    watch(id: FID, cb: () => void) {
        return this._watch([packKeyFID(id)], cb);
...
export class OrganizationFeatures extends FEntity {
    ...
    get organizationId(): FID {
        return unpackFID(this._value.organizationId);
    }
    set organizationId(value: FID) {
        this._checkIsWritable();
        if (value) {
            let converted = packFID(value);
            if (converted === this._value.organizationId) { return; }
            this._value.organizationId = value;
            this.markDirty();
        } else {
            if (!this._value.organizationId) { return; }
            this._value.organizationId = null;
            this.markDirty();
        }
    }
    get enabled(): boolean {
...
export class OrganizationFeaturesFactory extends FEntityFactory<OrganizationFeatures> {
    private static validate(src: any) {
        ...
        validators.isId('organizationId', src.organizationId);
        validators.notNull('enabled', src.enabled);
        validators.isBoolean('enabled', src.enabled);
    }
    ...
    async findFromOrganization(organizationId: FID, featureKey: string) {
        return await this._findById(['__indexes', 'organization', packKeyFID(organizationId), featureKey]);
    }
    async allFromOrganizationAfter(organizationId: FID, after: string) {
        return await this._findRangeAllAfter(['__indexes', 'organization', packKeyFID(organizationId)], after);
    }
    async rangeFromOrganization(organizationId: FID, limit: number, reversed?: boolean) {
        return await this._findRange(['__indexes', 'organization', packKeyFID(organizationId)], limit, reversed);
    }
    async rangeFromOrganizationWithCursor(organizationId: FID, limit: number, after?: string, reversed?: boolean) {
        return await this._findRangeWithCursor(['__indexes', 'organization', packKeyFID(organizationId)], limit, after, reversed);
    }
    async allFromOrganization(organizationId: FID) {
        return await this._findAll(['__indexes', 'organization', packKeyFID(organizationId)]);
    }
    createOrganizationStream(organizationId: FID, limit: number, after?: string) {
        return this._createStream(['entity', 'organizationFeatures', '__indexes', 'organization', packKeyFID(organizationId)], limit, after); 
    }
    protected _createEntity(value: any, isNew: boolean) {
...
export class SuperAdminFactory extends FEntityFactory<SuperAdmin> {
    ...
    async create(id: FID, shape: SuperAdminShape) {
        return await this._create([packKeyFID(id)], { id, ...shape });
    }
    watch(id: FID, cb: () => void) {
        return this._watch([packKeyFID(id)], cb);
...
export class UserSettingsFactory extends FEntityFactory<UserSettings> {
    ...
    async create(id: FID, shape: UserSettingsShape) {
        return await this._create([packKeyFID(id)], { id, ...shape });
    }
    watch(id: FID, cb: () => void) {
        return this._watch([packKeyFID(id)], cb);
...
export class ShortnameReservation extends FEntity {
    ...
    get ownerId(): FID {
        return unpackFID(this._value.ownerId);
    }
    set ownerId(value: FID) {
        this._checkIsWritable();
        if (value) {
            let converted = packFID(value);
            if (converted === this._value.ownerId) { return; }
            this._value.ownerId = value;
            this.markDirty();
        } else {
            if (!this._value.ownerId) { return; }
            this._value.ownerId = null;
            this.markDirty();
        }
    }
    get enabled(): boolean {
...
export class ShortnameReservationFactory extends FEntityFactory<ShortnameReservation> {
    private static validate(src: any) {
        ...
        validators.isId('ownerId', src.ownerId);
        validators.notNull('enabled', src.enabled);
        validators.isBoolean('enabled', src.enabled);
    }
    ...
    async findFromUser(ownerId: FID) {
        return await this._findById(['__indexes', 'user', packKeyFID(ownerId)]);
    }
    async findFromOrg(ownerId: FID) {
        return await this._findById(['__indexes', 'org', packKeyFID(ownerId)]);
    }
    protected _createEntity(value: any, isNew: boolean) {
...
export class ConversationSeq extends FEntity {
    get cid(): FID { return unpackFID(this._value.cid); }
    get seq(): number {
...
export class ConversationSeqFactory extends FEntityFactory<ConversationSeq> {
    ...
    async findById(cid: FID) {
        return await this._findById([packKeyFID(cid)]);
    }
    async create(cid: FID, shape: ConversationSeqShape) {
        return await this._create([packKeyFID(cid)], { cid, ...shape });
    }
    watch(cid: FID, cb: () => void) {
        return this._watch([packKeyFID(cid)], cb);
    }
    protected _createEntity(value: any, isNew: boolean) {
...
export class ConversationEvent extends FEntity {
    ...
    get uid(): FID | null {
        ...
        if (res) { return unpackFID(res); }
        return null;
    }
    set uid(value: FID | null) {
        this._checkIsWritable();
        if (value) {
            let converted = packFID(value);
            if (converted === this._value.uid) { return; }
    ...
    set mid(value: FID | null) {
        this._checkIsWritable();
        if (value) {
            let converted = packFID(value);
            if (converted === this._value.mid) { return; }
            this._value.mid = value;
            this.markDirty();
        } else {
            if (!this._value.mid) { return; }
            this._value.mid = null;
            this.markDirty();
        }
    }
...
export class ConversationEventFactory extends FEntityFactory<ConversationEvent> {
    ...
    async findById(cid: FID, seq: number) {
        return await this._findById([packKeyFID(cid), seq]);
    }
    async create(cid: FID, seq: number, shape: ConversationEventShape) {
        return await this._create([packKeyFID(cid), seq], { cid, seq, ...shape });
    }
    watch(cid: FID, seq: number, cb: () => void) {
        return this._watch([packKeyFID(cid), seq], cb);
    }
    async allFromUserAfter(cid: FID, after: number) {
        return await this._findRangeAllAfter(['__indexes', 'user', packKeyFID(cid)], after);
    }
    async rangeFromUser(cid: FID, limit: number, reversed?: boolean) {
        return await this._findRange(['__indexes', 'user', packKeyFID(cid)], limit, reversed);
    }
    async rangeFromUserWithCursor(cid: FID, limit: number, after?: string, reversed?: boolean) {
        return await this._findRangeWithCursor(['__indexes', 'user', packKeyFID(cid)], limit, after, reversed);
    }
    async allFromUser(cid: FID) {
        return await this._findAll(['__indexes', 'user', packKeyFID(cid)]);
    }
    createUserStream(cid: FID, limit: number, after?: string) {
        return this._createStream(['entity', 'conversationEvent', '__indexes', 'user', packKeyFID(cid)], limit, after); 
    }
    createUserLiveStream(cid: FID, limit: number, after?: string) {
        return this._createLiveStream(['entity', 'conversationEvent', '__indexes', 'user', packKeyFID(cid)], limit, after); 
    }
    protected _createEntity(value: any, isNew: boolean) {
...
export class UserDialogFactory extends FEntityFactory<UserDialog> {
    ...
    async findById(uid: FID, cid: FID) {
        return await this._findById([packKeyFID(uid), packKeyFID(cid)]);
    }
    async create(uid: FID, cid: FID, shape: UserDialogShape) {
        return await this._create([packKeyFID(uid), packKeyFID(cid)], { uid, cid, ...shape });
    }
    watch(uid: FID, cid: FID, cb: () => void) {
        return this._watch([packKeyFID(uid), packKeyFID(cid)], cb);
    }
    async allFromUserAfter(uid: FID, after: number) {
        return await this._findRangeAllAfter(['__indexes', 'user', packKeyFID(uid)], after);
    }
    async rangeFromUser(uid: FID, limit: number, reversed?: boolean) {
        return await this._findRange(['__indexes', 'user', packKeyFID(uid)], limit, reversed);
    ...
    createUserStream(uid: FID, limit: number, after?: string) {
        return this._createStream(['entity', 'userDialog', '__indexes', 'user', packKeyFID(uid)], limit, after); 
    }
    protected _createEntity(value: any, isNew: boolean) {
...
export class UserDialogSettingsFactory extends FEntityFactory<UserDialogSettings> {
    ...
    async create(uid: FID, cid: FID, shape: UserDialogSettingsShape) {
        return await this._create([packKeyFID(uid), packKeyFID(cid)], { uid, cid, ...shape });
    }
    watch(uid: FID, cid: FID, cb: () => void) {
        return this._watch([packKeyFID(uid), packKeyFID(cid)], cb);
...
export class UserDialogEvent extends FEntity {
    get uid(): FID { return unpackFID(this._value.uid); }
    get seq(): FID { return unpackFID(this._value.seq); }
    get cid(): FID | null {
        let res = this._value.cid;
        if (res) { return unpackFID(res); }
        return null;
    }
    set cid(value: FID | null) {
        this._checkIsWritable();
        if (value) {
            let converted = packFID(value);
            if (converted === this._value.cid) { return; }
            this._value.cid = value;
            this.markDirty();
        } else {
            if (!this._value.cid) { return; }
            this._value.cid = null;
            this.markDirty();
        }
    }
    get mid(): FID | null {
...
export class UserDialogEventFactory extends FEntityFactory<UserDialogEvent> {
    ...
    async findById(uid: FID, seq: FID) {
        return await this._findById([packKeyFID(uid), packKeyFID(seq)]);
    }
    async create(uid: FID, seq: FID, shape: UserDialogEventShape) {
        return await this._create([packKeyFID(uid), packKeyFID(seq)], { uid, seq, ...shape });
    }
    watch(uid: FID, seq: FID, cb: () => void) {
        return this._watch([packKeyFID(uid), packKeyFID(seq)], cb);
    }
    async allFromUserAfter(uid: FID, after: FID) {
        return await this._findRangeAllAfter(['__indexes', 'user', packKeyFID(uid)], after);
    }
    async rangeFromUser(uid: FID, limit: number, reversed?: boolean) {
        return await this._findRange(['__indexes', 'user', packKeyFID(uid)], limit, reversed);
    ...
    createUserStream(uid: FID, limit: number, after?: string) {
        return this._createStream(['entity', 'userDialogEvent', '__indexes', 'user', packKeyFID(uid)], limit, after); 
    }
    createUserLiveStream(uid: FID, limit: number, after?: string) {
        return this._createLiveStream(['entity', 'userDialogEvent', '__indexes', 'user', packKeyFID(uid)], limit, after); 
    }
    protected _createEntity(value: any, isNew: boolean) {
...
export class UserMessagingStateFactory extends FEntityFactory<UserMessagingState> {
    ...
    async create(uid: FID, shape: UserMessagingStateShape) {
        return await this._create([packKeyFID(uid)], { uid, ...shape });
    }
    watch(uid: FID, cb: () => void) {
        return this._watch([packKeyFID(uid)], cb);
...
export class UserNotificationsStateFactory extends FEntityFactory<UserNotificationsState> {
    ...
    async create(uid: FID, shape: UserNotificationsStateShape) {
        return await this._create([packKeyFID(uid)], { uid, ...shape });
    }
    watch(uid: FID, cb: () => void) {
        return this._watch([packKeyFID(uid)], cb);
...
export class MessageDraftFactory extends FEntityFactory<MessageDraft> {
    ...
    async create(uid: FID, cid: FID, shape: MessageDraftShape) {
        return await this._create([packKeyFID(uid), packKeyFID(cid)], { uid, cid, ...shape });
    }
    watch(uid: FID, cid: FID, cb: () => void) {
        return this._watch([packKeyFID(uid), packKeyFID(cid)], cb);
...
export class ChannelInvitation extends FEntity {
    get id(): FID { return unpackFID(this._value.id); }
    get creatorId(): FID {
        return unpackFID(this._value.creatorId);
    }
    set creatorId(value: FID) {
        this._checkIsWritable();
        if (value) {
            let converted = packFID(value);
            if (converted === this._value.creatorId) { return; }
            this._value.creatorId = value;
            this.markDirty();
        } else {
            if (!this._value.creatorId) { return; }
            this._value.creatorId = null;
            this.markDirty();
        }
    }
    get channelId(): FID {
        return unpackFID(this._value.channelId);
    }
    set channelId(value: FID) {
        this._checkIsWritable();
        if (value) {
            let converted = packFID(value);
            if (converted === this._value.channelId) { return; }
            this._value.channelId = value;
            this.markDirty();
        } else {
            if (!this._value.channelId) { return; }
            this._value.channelId = null;
            this.markDirty();
        }
    }
    get email(): string {
    ...
    get acceptedById(): FID | null {
        let res = this._value.acceptedById;
        if (res) { return unpackFID(res); }
        return null;
    }
    set acceptedById(value: FID | null) {
        this._checkIsWritable();
        if (value) {
            let converted = packFID(value);
            if (converted === this._value.acceptedById) { return; }
            this._value.acceptedById = value;
            this.markDirty();
        } else {
            if (!this._value.acceptedById) { return; }
            this._value.acceptedById = null;
            this.markDirty();
        }
    }
    get enabled(): boolean {
...
export class ChannelInvitationFactory extends FEntityFactory<ChannelInvitation> {
    private static validate(src: any) {
        ...
        validators.isId('creatorId', src.creatorId);
        validators.notNull('channelId', src.channelId);
        validators.isId('channelId', src.channelId);
        validators.notNull('email', src.email);
        validators.isString('email', src.email);
        validators.isString('firstName', src.firstName);
        validators.isString('lastName', src.lastName);
        validators.isString('text', src.text);
        validators.isId('acceptedById', src.acceptedById);
        validators.notNull('enabled', src.enabled);
        validators.isBoolean('enabled', src.enabled);
    }
    ...
    async create(id: FID, shape: ChannelInvitationShape) {
        return await this._create([packKeyFID(id)], { id, ...shape });
    }
    watch(id: FID, cb: () => void) {
        return this._watch([packKeyFID(id)], cb);
    }
    async allFromChannelAfter(createdAt: number, after: FID) {
...
export class AppInviteLinkFactory extends FEntityFactory<AppInviteLink> {
    ...
    async findFromUser(uid: FID) {
        return await this._findById(['__indexes', 'user', packKeyFID(uid)]);
    }
    protected _createEntity(value: any, isNew: boolean) {
