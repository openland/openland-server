...
export default declareSchema(() => {
    ...
    entity('IftttAuth', () => {
        // Short code used in bot (generated by us)
        primaryKey('id', string());
        // Provided by IFTTT
        field('state', string());
        // Provided by IFTTT
        field('redirectUrl', string());
        // Code generated by us, IFTTT will exchange it to token
        field('code', string());
        field('enabled', boolean());
        field('uid', optional(integer()));
    ...
    entity('ZapierAuth', () => {
        ...
        // Provided by Zapier
        field('redirectUrl', string());
        // Code generated by us, Zapier will exchange it to token
        field('code', string());
        field('enabled', boolean());
        field('uid', optional(integer()));
