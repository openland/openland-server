...
import { encoders, getTransaction, keyIncrement, Subspace } from '@openland/foundationdb';
        ...
        while (true) {
            ...
            while (true) {
                ...
                if (windowAdvanced) {
                    ...
                    getTransaction(ctx).rawWriteTransaction(this.counters.db).setOption(TransactionOptionCode.NextWriteNoWriteConflictRange);
            ...
            while (true) {
                ...
                if (res === null) {
                    getTransaction(ctx).rawWriteTransaction(this.counters.db).addWriteConflictRange(key, keyIncrement(key));
                    return candidate;
                }
            }
        }
