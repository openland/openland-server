...
import { VoiceChatReportsMediator } from './mediators/VoiceChatReportsMediator';
...
export function loadVoiceChatsModule() {
    ...
    container.bind('VoiceChatReportsMediator').to(VoiceChatReportsMediator).inSingletonScope();
}