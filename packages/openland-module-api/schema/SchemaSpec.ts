...
export interface GQLResolver {
    ConversationSettings?: ComplexTypedResolver<GQL.ConversationSettings, {}>;
    AnonymousConversation?: ComplexTypedResolver<GQL.AnonymousConversation, {topMessage: GQLRoots.ConversationMessageRoot, settings: GQLRoots.ConversationSettingsRoot}>;
    SharedConversation?: ComplexTypedResolver<GQL.SharedConversation, {organizations: GQLRoots.OrganizationRoot, topMessage: GQLRoots.ConversationMessageRoot, organization: GQLRoots.OrganizationRoot, settings: GQLRoots.ConversationSettingsRoot}>;
    PrivateConversation?: ComplexTypedResolver<GQL.PrivateConversation, {user: GQLRoots.UserRoot, topMessage: GQLRoots.ConversationMessageRoot, settings: GQLRoots.ConversationSettingsRoot}>;
    GroupConversation?: ComplexTypedResolver<GQL.GroupConversation, {members: GQLRoots.UserRoot, topMessage: GQLRoots.ConversationMessageRoot, settings: GQLRoots.ConversationSettingsRoot, photoRef: GQLRoots.ImageRefRoot, pinnedMessage: GQLRoots.ConversationMessageRoot}>;
    InviteServiceMetadata?: ComplexTypedResolver<GQL.InviteServiceMetadata, {users: GQLRoots.UserRoot, invitedBy: GQLRoots.UserRoot}>;
    KickServiceMetadata?: ComplexTypedResolver<GQL.KickServiceMetadata, {user: GQLRoots.UserRoot, kickedBy: GQLRoots.UserRoot}>;
    TitleChangeServiceMetadata?: ComplexTypedResolver<GQL.TitleChangeServiceMetadata, {}>;
    PhotoChangeServiceMetadata?: ComplexTypedResolver<GQL.PhotoChangeServiceMetadata, {photoRef: GQLRoots.ImageRefRoot}>;
    UrlAugmentation?: ComplexTypedResolver<GQL.UrlAugmentation, {photo: GQLRoots.ImageRefRoot, imageInfo: GQLRoots.FileMetadataRoot, iconRef: GQLRoots.ImageRefRoot, iconInfo: GQLRoots.FileMetadataRoot, extra: GQLRoots.UrlAugmentationExtraRoot}>;
    MessageReaction?: ComplexTypedResolver<GQL.MessageReaction, {user: GQLRoots.UserRoot}>;
    ConversationMessage?: ComplexTypedResolver<GQL.ConversationMessage, {fileMetadata: GQLRoots.FileMetadataRoot, sender: GQLRoots.UserRoot, serviceMetadata: GQLRoots.ServiceMetadataRoot, urlAugmentation: GQLRoots.UrlAugmentationRoot, reactions: GQLRoots.MessageReactionRoot, replyMessages: GQLRoots.ConversationMessageRoot, mentions: GQLRoots.UserRoot}>;
    FileMetadata?: ComplexTypedResolver<GQL.FileMetadata, {}>;
    StickerPack?: ComplexTypedResolver<GQL.StickerPack, {stickers: GQLRoots.StickerRoot}>;
    Sticker?: ComplexTypedResolver<GQL.Sticker, {meta: GQLRoots.FileMetadataRoot}>;
    ConversationEventSimpleBatch?: ComplexTypedResolver<GQL.ConversationEventSimpleBatch, {events: GQLRoots.ConversationEventRoot}>;
    ConversationEventMessage?: ComplexTypedResolver<GQL.ConversationEventMessage, {message: GQLRoots.ConversationMessageRoot}>;
    ConversationEventEditMessage?: ComplexTypedResolver<GQL.ConversationEventEditMessage, {message: GQLRoots.ConversationMessageRoot}>;
    ConversationEventDelete?: ComplexTypedResolver<GQL.ConversationEventDelete, {}>;
    ConversationEventNewMembers?: ComplexTypedResolver<GQL.ConversationEventNewMembers, {users: GQLRoots.UserRoot, invitedBy: GQLRoots.UserRoot}>;
    ConversationEventKick?: ComplexTypedResolver<GQL.ConversationEventKick, {user: GQLRoots.UserRoot, kickedBy: GQLRoots.UserRoot}>;
    ConversationEventTitle?: ComplexTypedResolver<GQL.ConversationEventTitle, {}>;
    ConversationEventUpdate?: ComplexTypedResolver<GQL.ConversationEventUpdate, {chat: GQLRoots.ConversationRoot}>;
    ConversationEventUpdateRole?: ComplexTypedResolver<GQL.ConversationEventUpdateRole, {user: GQLRoots.UserRoot}>;
    ConversationState?: ComplexTypedResolver<GQL.ConversationState, {messages: GQLRoots.ConversationMessageRoot}>;
    ConversationConnection?: ComplexTypedResolver<GQL.ConversationConnection, {conversations: GQLRoots.ConversationRoot, counter: GQLRoots.NotificationCounterRoot}>;
    NotificationCounter?: ComplexTypedResolver<GQL.NotificationCounter, {}>;
    ChatReadResult?: ComplexTypedResolver<GQL.ChatReadResult, {conversation: GQLRoots.ConversationRoot, counter: GQLRoots.NotificationCounterRoot}>;
    GroupConversationMember?: ComplexTypedResolver<GQL.GroupConversationMember, {user: GQLRoots.UserRoot}>;
    GroupChatUpdateResponse?: ComplexTypedResolver<GQL.GroupChatUpdateResponse, {chat: GQLRoots.ConversationRoot, chatEventMessage: GQLRoots.ConversationEventMessageRoot, chatEvent: GQLRoots.ConversationEventRoot}>;
    ConversationUpdateResponse?: ComplexTypedResolver<GQL.ConversationUpdateResponse, {chat: GQLRoots.ConversationRoot}>;
    ConversationBlockedUser?: ComplexTypedResolver<GQL.ConversationBlockedUser, {user: GQLRoots.UserRoot, blockedBy: GQLRoots.UserRoot}>;
    Profile?: ComplexTypedResolver<GQL.Profile, {photoRef: GQLRoots.ImageRefRoot, primaryOrganization: GQLRoots.OrganizationRoot, alphaPrimaryOrganization: GQLRoots.OrganizationRoot, alphaInvitedBy: GQLRoots.UserRoot}>;
    AlphaSignupData?: ComplexTypedResolver<GQL.AlphaSignupData, {user: GQLRoots.UserRoot, organization: GQLRoots.OrganizationRoot}>;
    Invite?: ComplexTypedResolver<GQL.Invite, {}>;
    InviteInfo?: ComplexTypedResolver<GQL.InviteInfo, {photoRef: GQLRoots.ImageRefRoot, creator: GQLRoots.UserRoot}>;
    AppInvite?: ComplexTypedResolver<GQL.AppInvite, {inviter: GQLRoots.UserRoot}>;
    AppInviteInfo?: ComplexTypedResolver<GQL.AppInviteInfo, {inviter: GQLRoots.UserRoot}>;
    InviteHistotyInfo?: ComplexTypedResolver<GQL.InviteHistotyInfo, {acceptedBy: GQLRoots.UserRoot}>;
    Reaction?: ComplexTypedResolver<GQL.Reaction, {user: GQLRoots.UserRoot}>;
    Message?: ComplexTypedResolver<GQL.Message, {sender: GQLRoots.UserRoot, quoted: GQLRoots.MessageRoot, alphaReactions: GQLRoots.ReactionRoot}>;
    Dialog?: ComplexTypedResolver<GQL.Dialog, {topMessage: GQLRoots.MessageRoot}>;
    DialogsConnection?: ComplexTypedResolver<GQL.DialogsConnection, {items: GQLRoots.DialogRoot}>;
    Settings?: ComplexTypedResolver<GQL.Settings, {}>;
    OrganizationIvitedMember?: ComplexTypedResolver<GQL.OrganizationIvitedMember, {}>;
    OrganizationJoinedMember?: ComplexTypedResolver<GQL.OrganizationJoinedMember, {user: GQLRoots.UserRoot}>;
    OnlineEvent?: ComplexTypedResolver<GQL.OnlineEvent, {user: GQLRoots.UserRoot}>;
    SuperAccount?: ComplexTypedResolver<GQL.SuperAccount, {members: GQLRoots.UserRoot, features: GQLRoots.FeatureFlagRoot, createdBy: GQLRoots.UserRoot}>;
    SuperAdmin?: ComplexTypedResolver<GQL.SuperAdmin, {user: GQLRoots.UserRoot}>;
    PageInfo?: ComplexTypedResolver<GQL.PageInfo, {}>;
    Task?: ComplexTypedResolver<GQL.Task, {}>;
    ImageCrop?: ComplexTypedResolver<GQL.ImageCrop, {}>;
    ImageRef?: ComplexTypedResolver<GQL.ImageRef, {crop: GQLRoots.ImageCropRoot}>;
    Range?: ComplexTypedResolver<GQL.Range, {}>;
    ChannelConversation?: ComplexTypedResolver<GQL.ChannelConversation, {members: GQLRoots.UserRoot, topMessage: GQLRoots.ConversationMessageRoot, settings: GQLRoots.ConversationSettingsRoot, organization: GQLRoots.OrganizationRoot, photoRef: GQLRoots.ImageRefRoot, socialImageRef: GQLRoots.ImageRefRoot, pinnedMessage: GQLRoots.ConversationMessageRoot}>;
    ChannelMemberOrg?: ComplexTypedResolver<GQL.ChannelMemberOrg, {organization: GQLRoots.OrganizationRoot}>;
    ChannelMember?: ComplexTypedResolver<GQL.ChannelMember, {user: GQLRoots.UserRoot}>;
    ChannelInvite?: ComplexTypedResolver<GQL.ChannelInvite, {channel: GQLRoots.ChannelConversationRoot, invitedByUser: GQLRoots.UserRoot}>;
    ChannelOrgInvite?: ComplexTypedResolver<GQL.ChannelOrgInvite, {channel: GQLRoots.ChannelConversationRoot, invitedByOrg: GQLRoots.OrganizationRoot, invitedByUser: GQLRoots.UserRoot}>;
    ChannelJoinRequestOrg?: ComplexTypedResolver<GQL.ChannelJoinRequestOrg, {organization: GQLRoots.OrganizationRoot, user: GQLRoots.UserRoot}>;
    ChannelConversationConnectionEdge?: ComplexTypedResolver<GQL.ChannelConversationConnectionEdge, {node: GQLRoots.ChannelConversationRoot}>;
    ChannelConversationConnection?: ComplexTypedResolver<GQL.ChannelConversationConnection, {edges: GQLRoots.ChannelConversationConnectionEdgeRoot, pageInfo: GQLRoots.PageInfoRoot}>;
    ConversationUpdateSingle?: ComplexTypedResolver<GQL.ConversationUpdateSingle, {update: GQLRoots.ConversationUpdateRoot}>;
    ConversationUpdateBatch?: ComplexTypedResolver<GQL.ConversationUpdateBatch, {updates: GQLRoots.ConversationUpdateRoot}>;
    ConversationMessageReceived?: ComplexTypedResolver<GQL.ConversationMessageReceived, {message: GQLRoots.ConversationMessageRoot}>;
    ConversationMessageUpdated?: ComplexTypedResolver<GQL.ConversationMessageUpdated, {message: GQLRoots.ConversationMessageRoot}>;
    ConversationMessageDeleted?: ComplexTypedResolver<GQL.ConversationMessageDeleted, {message: GQLRoots.ConversationMessageRoot}>;
    DialogUpdateSingle?: ComplexTypedResolver<GQL.DialogUpdateSingle, {update: GQLRoots.DialogUpdateRoot}>;
    DialogUpdateBatch?: ComplexTypedResolver<GQL.DialogUpdateBatch, {updates: GQLRoots.DialogUpdateRoot}>;
    DialogMessageReceived?: ComplexTypedResolver<GQL.DialogMessageReceived, {message: GQLRoots.ConversationMessageRoot}>;
    DialogMessageUpdated?: ComplexTypedResolver<GQL.DialogMessageUpdated, {message: GQLRoots.ConversationMessageRoot}>;
    DialogMessageDeleted?: ComplexTypedResolver<GQL.DialogMessageDeleted, {message: GQLRoots.ConversationMessageRoot}>;
    DialogMessageRead?: ComplexTypedResolver<GQL.DialogMessageRead, {}>;
    DialogTitleUpdated?: ComplexTypedResolver<GQL.DialogTitleUpdated, {}>;
    DialogPhotoUpdated?: ComplexTypedResolver<GQL.DialogPhotoUpdated, {photoRef: GQLRoots.ImageRefRoot}>;
    FeatureFlag?: ComplexTypedResolver<GQL.FeatureFlag, {}>;
    OrganizationContact?: ComplexTypedResolver<GQL.OrganizationContact, {photoRef: GQLRoots.ImageRefRoot}>;
    Organization?: ComplexTypedResolver<GQL.Organization, {alphaOrganizationMembers: GQLRoots.OrganizationJoinedMemberRoot, alphaCreatedChannels: GQLRoots.ChannelConversationRoot}>;
    OrganizationsEdge?: ComplexTypedResolver<GQL.OrganizationsEdge, {node: GQLRoots.OrganizationRoot}>;
    OrganizationsConnection?: ComplexTypedResolver<GQL.OrganizationsConnection, {edges: GQLRoots.OrganizationsEdgeRoot, pageInfo: GQLRoots.PageInfoRoot}>;
    OrganizationProfile?: ComplexTypedResolver<GQL.OrganizationProfile, {photoRef: GQLRoots.ImageRefRoot, contacts: GQLRoots.OrganizationContactRoot, alphaPotentialSites: GQLRoots.RangeRoot, alphaSiteSizes: GQLRoots.RangeRoot, alphaJoinedChannels: GQLRoots.ChannelConversationRoot, alphaCreatedChannels: GQLRoots.ChannelConversationRoot}>;
    Permissions?: ComplexTypedResolver<GQL.Permissions, {}>;
    ProfilePrefill?: ComplexTypedResolver<GQL.ProfilePrefill, {}>;
    PushSettings?: ComplexTypedResolver<GQL.PushSettings, {}>;
    SessionState?: ComplexTypedResolver<GQL.SessionState, {}>;
    TypingEvent?: ComplexTypedResolver<GQL.TypingEvent, {conversation: GQLRoots.ConversationRoot, user: GQLRoots.UserRoot}>;
    User?: ComplexTypedResolver<GQL.User, {channelsJoined: GQLRoots.ChannelConversationRoot, photoRef: GQLRoots.ImageRefRoot, pictureRef: GQLRoots.ImageRefRoot}>;
    UserEdge?: ComplexTypedResolver<GQL.UserEdge, {node: GQLRoots.UserRoot}>;
    UserConnection?: ComplexTypedResolver<GQL.UserConnection, {edges: GQLRoots.UserEdgeRoot, pageInfo: GQLRoots.PageInfoRoot}>;
    PrivateRoom?: ComplexTypedResolver<GQL.PrivateRoom, {user: GQLRoots.UserRoot}>;
    SharedRoom?: ComplexTypedResolver<GQL.SharedRoom, {}>;
}
