...
export const GQL_SPEC_VERSION = '931bea94c26d78239f70642af406ddf9';
...
export namespace GQL {
    ...
    export interface MutationUpdateOuathAppArgs {
        clientId: string;
        input: OauthAppInput;
    }
    ...
    export interface Query {
        ...
        chatMentionSearch: GlobalSearchEntry[];
