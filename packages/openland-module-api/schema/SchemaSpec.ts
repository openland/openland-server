...
export const GQL_SPEC_VERSION = '3cefe81a752dea5ffff35b784b74a992';
...
export namespace GQL {
    ...
    export interface Notification {
        id: string;
        text: Nullable<string>;
        content: Nullable<Nullable<NotificationContent>[]>;
    }
    ...
    export type NotificationCenterUpdate = NotificationReceived | NotificationRead;
    ...
    export type CommentPeerRoot = GeneralMessage;
...
export interface GQLResolver {
    ...
    Notification?: ComplexTypedResolver<GQL.Notification, GQLRoots.NotificationRoot, {content: Nullable<Nullable<GQLRoots.NotificationContentRoot>[]>}, {}>;
    ...
    NotificationCenterUpdate?: UnionTypeResolver<GQLRoots.NotificationCenterUpdateRoot, 'NotificationReceived' | 'NotificationRead'>;
    ...
    CommentPeerRoot?: UnionTypeResolver<GQLRoots.CommentPeerRootRoot, 'GeneralMessage'>;
