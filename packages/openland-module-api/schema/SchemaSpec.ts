...
export const GQL_SPEC_VERSION = '2e64394c9ab2efd184f38eb061ba9932';
...
export namespace GQL {
    ...
    export interface Query {
        ...
        debugMessagesSearch: MessageConnection;
    ...
    export interface QueryDebugMessagesSearchArgs {
        uid: string;
        query: string;
