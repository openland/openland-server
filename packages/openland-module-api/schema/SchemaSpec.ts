...
export namespace GQL {
    ...
    export interface Mutation {
        ...
        matchmakingRoomCreate: MatchmakingRoom;
    ...
    export interface MutationMatchmakingRoomCreateArgs {
        peerId: string;
