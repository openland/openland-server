...
export interface GQLResolver {
    ...
    AnonymousConversation?: ComplexTypedResolver<GQL.AnonymousConversation, {topMessage: Nullable<GQLRoots.ConversationMessageRoot>, settings: GQLRoots.ConversationSettingsRoot}>;
    SharedConversation?: ComplexTypedResolver<GQL.SharedConversation, {organizations: GQLRoots.OrganizationRoot[], topMessage: Nullable<GQLRoots.ConversationMessageRoot>, organization: Nullable<GQLRoots.OrganizationRoot>, settings: GQLRoots.ConversationSettingsRoot}>;
    PrivateConversation?: ComplexTypedResolver<GQL.PrivateConversation, {user: GQLRoots.UserRoot, topMessage: Nullable<GQLRoots.ConversationMessageRoot>, settings: GQLRoots.ConversationSettingsRoot}>;
    GroupConversation?: ComplexTypedResolver<GQL.GroupConversation, {members: GQLRoots.UserRoot[], topMessage: Nullable<GQLRoots.ConversationMessageRoot>, settings: GQLRoots.ConversationSettingsRoot, photoRef: Nullable<GQLRoots.ImageRefRoot>, pinnedMessage: Nullable<GQLRoots.ConversationMessageRoot>}>;
    InviteServiceMetadata?: ComplexTypedResolver<GQL.InviteServiceMetadata, {users: Nullable<GQLRoots.UserRoot[]>, invitedBy: GQLRoots.UserRoot}>;
    ...
    PhotoChangeServiceMetadata?: ComplexTypedResolver<GQL.PhotoChangeServiceMetadata, {photoRef: Nullable<GQLRoots.ImageRefRoot>}>;
    UrlAugmentation?: ComplexTypedResolver<GQL.UrlAugmentation, {photo: Nullable<GQLRoots.ImageRefRoot>, imageInfo: Nullable<GQLRoots.FileMetadataRoot>, iconRef: Nullable<GQLRoots.ImageRefRoot>, iconInfo: Nullable<GQLRoots.FileMetadataRoot>, extra: Nullable<GQLRoots.UrlAugmentationExtraRoot>}>;
    MessageReaction?: ComplexTypedResolver<GQL.MessageReaction, {user: GQLRoots.UserRoot}>;
    ConversationMessage?: ComplexTypedResolver<GQL.ConversationMessage, {fileMetadata: Nullable<GQLRoots.FileMetadataRoot>, sender: GQLRoots.UserRoot, serviceMetadata: Nullable<GQLRoots.ServiceMetadataRoot>, urlAugmentation: Nullable<GQLRoots.UrlAugmentationRoot>, reactions: GQLRoots.MessageReactionRoot[], replyMessages: Nullable<GQLRoots.ConversationMessageRoot[]>, mentions: Nullable<GQLRoots.UserRoot[]>}>;
    FileMetadata?: ComplexTypedResolver<GQL.FileMetadata, {}>;
    StickerPack?: ComplexTypedResolver<GQL.StickerPack, {stickers: Nullable<GQLRoots.StickerRoot[]>}>;
    ...
    ConversationEventNewMembers?: ComplexTypedResolver<GQL.ConversationEventNewMembers, {users: Nullable<GQLRoots.UserRoot[]>, invitedBy: GQLRoots.UserRoot}>;
    ...
    GroupChatUpdateResponse?: ComplexTypedResolver<GQL.GroupChatUpdateResponse, {chat: GQLRoots.ConversationRoot, chatEventMessage: Nullable<GQLRoots.ConversationEventMessageRoot>, chatEvent: Nullable<GQLRoots.ConversationEventRoot>}>;
    ...
    Profile?: ComplexTypedResolver<GQL.Profile, {photoRef: Nullable<GQLRoots.ImageRefRoot>, alphaInvitedBy: Nullable<GQLRoots.UserRoot>}>;
    AlphaSignupData?: ComplexTypedResolver<GQL.AlphaSignupData, {user: Nullable<GQLRoots.UserRoot>, organization: Nullable<GQLRoots.OrganizationRoot>}>;
    Invite?: ComplexTypedResolver<GQL.Invite, {}>;
    InviteInfo?: ComplexTypedResolver<GQL.InviteInfo, {photoRef: Nullable<GQLRoots.ImageRefRoot>, creator: Nullable<GQLRoots.UserRoot>}>;
    ...
    InviteHistotyInfo?: ComplexTypedResolver<GQL.InviteHistotyInfo, {acceptedBy: Nullable<GQLRoots.UserRoot>}>;
    ...
    Dialog?: ComplexTypedResolver<GQL.Dialog, {topMessage: Nullable<GQLRoots.MessageRoot>}>;
    ...
    SuperAccount?: ComplexTypedResolver<GQL.SuperAccount, {members: GQLRoots.UserRoot[], features: GQLRoots.FeatureFlagRoot[], createdBy: Nullable<GQLRoots.UserRoot>}>;
    ...
    ImageRef?: ComplexTypedResolver<GQL.ImageRef, {crop: Nullable<GQLRoots.ImageCropRoot>}>;
    ...
    DialogPhotoUpdated?: ComplexTypedResolver<GQL.DialogPhotoUpdated, {photoRef: Nullable<GQLRoots.ImageRefRoot>}>;
    FeatureFlag?: ComplexTypedResolver<GQL.FeatureFlag, {}>;
    OrganizationContact?: ComplexTypedResolver<GQL.OrganizationContact, {photoRef: Nullable<GQLRoots.ImageRefRoot>}>;
    Organization?: ComplexTypedResolver<GQL.Organization, {alphaOrganizationMembers: GQLRoots.OrganizationJoinedMemberRoot[], alphaCreatedChannels: Nullable<GQLRoots.ChannelConversationRoot>[]}>;
    ...
    User?: ComplexTypedResolver<GQL.User, {channelsJoined: GQLRoots.ChannelConversationRoot[], photoRef: Nullable<GQLRoots.ImageRefRoot>, pictureRef: Nullable<GQLRoots.ImageRefRoot>}>;
    ...
    SharedRoom?: ComplexTypedResolver<GQL.SharedRoom, {organization: GQLRoots.OrganizationRoot}>;
}
