...
export const GQL_SPEC_VERSION = '20f754526727c6358b0a90d2295b0b1b';
...
export namespace GQL {
    ...
    export interface MutationRefreshBotTokenArgs {
        botId: string;
    }
    export interface MutationUpdateBotProfileArgs {
        botId: string;
...
export interface GQLResolver {
    ...
    Bot?: ComplexTypedResolver<GQL.Bot, GQLRoots.BotRoot, {bot: GQLRoots.UserRoot, token: GQLRoots.BotTokenRoot}, {}>;
    BotToken?: ComplexTypedResolver<GQL.BotToken, GQLRoots.BotTokenRoot, {}, {}>;
