...
export const GQL_SPEC_VERSION = '19c06733a76832cf91be8338f0798741';
...
export namespace GQL {
    ...
    export interface Mutation {
        ...
        alphaPinMessage: Room;
        alphaUnpinMessage: Room;
    ...
    export interface MutationAlphaPinMessageArgs {
        chatId: string;
        messageId: string;
    }
    export interface MutationAlphaUnpinMessageArgs {
        chatId: string;
    }
