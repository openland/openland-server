...
export const GQL_SPEC_VERSION = 'c1e2e16d9c8be8a48324a13d1b061fe8';
...
export namespace GQL {
    ...
    export type FeedUpdate = FeedItemReceived | FeedItemUpdated;
...
export interface GQLResolver {
    ...
    FeedUpdate?: UnionTypeResolver<GQLRoots.FeedUpdateRoot, 'FeedItemReceived' | 'FeedItemUpdated'>;
    FeedItemReceived?: ComplexTypedResolver<GQL.FeedItemReceived, GQLRoots.FeedItemReceivedRoot, {post: GQLRoots.FeedItemRoot}, {}>;
    FeedItemUpdated?: ComplexTypedResolver<GQL.FeedItemUpdated, GQLRoots.FeedItemUpdatedRoot, {post: GQLRoots.FeedItemRoot}, {}>;
