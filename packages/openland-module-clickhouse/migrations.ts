...
//
migrations.push({
    name: 'AUTOGENERATED-room_participants-create',
    command: async (ctx: Context, db: DatabaseClient) => {
        await db.createTable(
                ctx, 
                'room_participants', 
                 // tslint:disable-next-line
                [{"name":"uid","type":"Int64"},{"name":"cid","type":"Int64"},{"name":"deleted","type":"UInt8"},{"name":"sign","type":"Int8"}], 
                'cid', 
                '(cid, uid)', 
                '(cid, uid)', 
                'CollapsingMergeTree(sign)'
...
//
migrations.push({
    name: 'AUTOGENERATED-room-create',
    command: async (ctx: Context, db: DatabaseClient) => {
        await db.createTable(
                ctx, 
                'room', 
                 // tslint:disable-next-line
                [{"name":"id","type":"Int64"},{"name":"kind","type":"String"},{"name":"oid","type":"Nullable(Int64)"},{"name":"deleted","type":"UInt8"},{"name":"sign","type":"Int8"}], 
                'id', 
                'id', 
                'id', 
                'CollapsingMergeTree(sign)'
...
//
migrations.push({
    name: 'AUTOGENERATED-follow-create',
    command: async (ctx: Context, db: DatabaseClient) => {
        await db.createTable(
                ctx, 
                'follow', 
                 // tslint:disable-next-line
                [{"name":"follower","type":"Int64"},{"name":"followed","type":"Int64"},{"name":"id","type":"String"},{"name":"date","type":"DateTime"}], 
                'toYYYYMM(date)', 
                '(id, date)', 
                'id', 
                'MergeTree()'
...
//
migrations.push({
    name: 'AUTOGENERATED-voice_chat_ended-create',
    command: async (ctx: Context, db: DatabaseClient) => {
        await db.createTable(
                ctx, 
                'voice_chat_ended', 
                 // tslint:disable-next-line
                [{"name":"cid","type":"Int64"},{"name":"duration","type":"Int64"},{"name":"attendance","type":"Int64"},{"name":"id","type":"String"},{"name":"date","type":"DateTime"}], 
                'toYYYYMM(date)', 
                '(id, date)', 
                'id', 
                'MergeTree()'
