...
export function privateMessagesIndexer() {
    declareSearchIndexer({
        name: 'private-message-index',
        version: 3,
        index: 'private-message',
        stream: Store.PrivateMessage.updated.stream({ batchSize: 200 })
    }).withProperties({
        id: {
            type: 'integer'
        },
