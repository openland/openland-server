...
export class PresenceGroupService {
    ...
    async start() {
        this.subscription = EventBus.subscribe('presence', `presences.groups-notify.${this.group.cid}`, (data) => {
    ...
    private notifyOnlineStatus = throttle(2000, () => {
        ...
        EventBus.publish('presence', `presences.group.${this.group.cid}`, { online: this.online });
    });
